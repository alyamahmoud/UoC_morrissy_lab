...
incidMat <- readr::read_rds('/work/morrissy_lab/alyaa.mohamed/OpenPBTA/OpenPBTA-analysis/int/2.6_regulons_asIncidMat.Rds')
...
for (comb in 1:ncol(R_comb)) {
 ...
 saveRDS(Regulon_comb, file = '/work/morrissy_lab/alyaa.mohamed/OpenPBTA/OpenPBTA-analysis/int/Regulon_comb_rsem_matched_proteomics.Rds')
